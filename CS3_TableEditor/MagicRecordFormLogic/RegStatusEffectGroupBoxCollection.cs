...
namespace CS3_TableEditor.MagicRecordFormLogic {
    public class RegStatusEffectGroupBoxCollection {

        private List<StatusEffectGroupBoxContents> contents;
        private List<RegStatusEffect> statusEffects;
        private Button statusEffectCreateNewBtn;
        private ToolTip toolTip;

        public RegStatusEffectGroupBoxCollection(List<RegStatusEffect> statusEffects, ToolTip statusEffectTooltip, Button statusEffectCreateNewBtn,
        ...
        public void MoveLeft(int index) {
            RegStatusEffect statusEffect = statusEffects[index];
